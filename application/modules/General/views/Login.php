      ...
      <body>
          <div class="text-center shadow p-3 mb-5 bg-white rounded" id="form-signin" name="form-signin">
              <form class="form-signin" id="form_Login" name="form_Login" method="POST" role="form">
                  ...
                  <input type="text" id="nickName" name="nickName" class="form-control text-center"  placeholder="Usuario" required=""
                      autofocus="">
                  ...
                  <div style="margin-top: 10px;" class="row">
                      <div class="col-lg-12">
                          <input type="text" name="captcha" id="captcha" class="form-control center-text" autocomplete="off"
                              placeholder="Captcha" required autofocus>
                      </div>
                  </div>
