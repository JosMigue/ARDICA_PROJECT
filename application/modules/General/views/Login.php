      ...
      'Creer' al servidor de que el archivo al que se hace referencia es uno diferente cada vez que se recarga la pagina,
      lo que evitará que en futuras modificaciones  (en el caso del uso del Chrome) no será necesario limpiar la cache 
      ...
      <head>
          ...
          <meta name="author" content="Ingeniero José Miguel">
      ...
      <body>
          <div class="text-center shadow p-3 mb-5 bg-white rounded" id="form-signin" name="form-signin">
              <form class="form-signin" id="form_Login" name="form_Login" method="POST" role="form">
                  ...
                  <input type="text" id="nickName" name="nickName" class="form-control text-center" placeholder="Usuario" required="" autofocus="">
                  <label for="inputPassword" class="sr-only">Contraseña</label>
                  <input type="password" id="inputPassword" name="inputPassword" class="form-control text-center" placeholder="Contraseña" required="">
                  <div class="row">
                      <div class="col-lg-6">
