...
:root {
  ...
  --animation-sentence: '¿Podrías salirte de esta página?, me harías un gran favor';
...
@keyframes showText {
  ...
  100% {
    --animation-sentence: 'Hay un buen de cosas por hacer, pero hay muy poco tiempo :( ...';
  }
}
@keyframes showNewText {
  ...
  100% {
    --animation-sentence: 'Okay, parace que te interesa mucho esta página :). Aquí tengo un llave para ti ;)';
  }
}
