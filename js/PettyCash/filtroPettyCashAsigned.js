    ...
    var lastColumn = true;
      settings= {
          ...
          "processing":true,
            "serverSide":true, 
            "ajax":{
                    "url":"PettyCash/getAllPettyCashAuthorized", 
                    "type":"POST",
                    "data": function (d) {
/*                       d.numeroCajaChica = $('#numberFilter').val();
            ...
            "columns": [
              {
                ...
                "columnDefs": [{ className: "contador", "targets": [ 1 ] }, 
                        ...
                        {"render": function ( data, type, row ) {
                          if(row.status == 1){
                            return '<button class="btn btn-success" onclick="openModal(this)" value="'+row.Id_db+'" name="'+row.numero+'" data-toggle="tooltip" data-placement="top" title="Agegar gasto"><i class="material-icons">add_circle</i></button>';
                          }
                                },
                                "targets": 9
                        },
      ...
      table= $('#petty_Cash_Table_Asigned').DataTable(settings)
      
      $('#petty_Cash_Table_Asigned tbody').on('click', 'td.details-control', function () {
      ...
      $.ajax({
        headers: {
          ...
          type: "POST",
          url: "PettyCash/getPettyCashDetailAuthorized",
